...
return [
    ...
    */
    'custom' => [
//        'questions' => [
//            'required'  => 'Поле "Список вопросов" должно быть заполнено',
//        ],
//        'results' => [
//            'required'  => 'Поле "Результаты" должно быть заполнено',
//        ],
        'addr' => [
            'required'  => 'Шифр здания не выбран',
            'exists'    => 'Шифр здания не выбран или отсутствует в базе данных',
        ],
        'company_id' => [
            'required'  => 'Не выбрана управляющая организация',
        ],
    ],
    /*
    |--------------------------------------------------------------------------
